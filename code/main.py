...
if __name__ == '__main__':
    ...
    parser.add_argument('--src', default=r'imgs/rank1.PNG', help='Path for source image(default: imgs/test6.jpg)')
    parser.add_argument('--dst', default=r'imgs/groundTruth.PNG', help='Path for target image')
    parser.add_argument('--out', default=r'results/test.jpg', help='Path for storing output images')
